...
export default function PostCard({ post }: { post: PostProps }) {
  ...
  return (
    <div className="bg-white border rounded-xl overflow-hidden">
      <Link href={`/profile/?id=${post.author.id}`} className="flex items-center gap-3 p-4">
      ...
      <div className="p-4">
        ...
        <button onClick={handleLike} className="flex items-center gap-1.5 text-sm" style={{ color: liked ? "#EF4444" : "var(--muted)" }}>
